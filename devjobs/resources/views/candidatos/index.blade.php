...
@if(count($vacante->candidatos)>0)
    ...
    <ul class="max-w-md mx-auto mt-10">
        @foreach ($vacante->candidatos as $candidato)
            <li class="p-5 border border-gray-400 mb-5 text-center">
                ...
                <a class="bg-blue-500 hover:bg-blue-800 p-3 inline-block text-xs font-bold uppercase text-white" href="/storage/cv/{{ $candidato->cv }}">Ver CV</a>

            </li>
        @endforeach
    </ul>
@else
<p class="text-center mt-5">No hay candidatos por el momento</p>
@endif
@endsection
