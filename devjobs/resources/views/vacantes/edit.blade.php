...
@section('content')
<h1 class="text-2xl text-center mt-10">Editar {{ $vacante->titulo }} </h1>
...
<form
 ...
 @method('put')
    <div class="mb-5">
        ...
        border-red-500 border @enderror" name="titulo" value="{{ $vacante->titulo }}"
   ...
   <button type="submit" class="my-10 bg-blue-500 w-full hover:bg-blue-700 text-gray-100 p-3 focus:outline-none focus:shadow-outline uppercase font-bold">Editar</button>
